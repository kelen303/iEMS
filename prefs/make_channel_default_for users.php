...
mysql_select_db($database_crsolutions, $crsolutions);
$query_userprefs = "SELECT * FROM t_userpreferences t1, t_objects t2 WHERE t1.preferencetypeid = '1' and t1.userobjectid = t2.objectid ORDER BY t2.objectdescription";
...
mysql_select_db($database_crsolutions, $crsolutions);
$query_unnattachedpoints = "SELECT * FROM t_pointchannels where isenabled ='1' order by channeldescription";
...
<title>Make Any Channel Viewable By Any User</title>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <p align="center">&nbsp;</p>
  <p align="center">&nbsp;</p>
  <p align="center">Adding &quot;Default&quot; Priviledges From User To Channel </p>
  <p align="center">&nbsp;</p>
  <p align="center">&nbsp;</p>
  <p align="center">This is a complete list of all users and points. Users missing from here don't yet have preferences enabled.</p>
  <table align="center">
    <tr valign="baseline">
