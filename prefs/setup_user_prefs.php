...
mysql_select_db($database_crsolutions, $crsolutions);
$query_userswithoutprefs = "SELECT * FROM t_objects t1 Left Join t_userpreferences t2 on t1.objectid = t2.userobjectid WHERE t1.objecttypeid = '1'and t1.isinactive ='0'  and preferencetypeid is null ORDER BY objectdescription";
