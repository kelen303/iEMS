...
mysql_select_db($database_crsolutions, $crsolutions);
$query_userswithoutprefs = "SELECT t_objects.* FROM t_objects,    t_users LEFT JOIN t_userpreferences ON t_users.ObjectID = t_userpreferences.UserObjectID and   t_userpreferences.PreferenceTypeID=1 WHERE t_userpreferences.UserObjectID IS NULL and    t_objects.ObjectID = t_users.ObjectID ORDER BY ObjectDescription";
...
?>
  ...
  <input type="hidden" name="PreferenceTypeID" value="1">
