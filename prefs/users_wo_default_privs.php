...
$query_uers_wo_prefs = "SELECT     t_objects.* FROM     t_objects,    t_users LEFT JOIN t_userpreferences ON t_users.ObjectID = t_userpreferences.UserObjectID and   t_userpreferences.PreferenceTypeID=1 WHERE     t_userpreferences.UserObjectID IS NULL and    t_objects.ObjectID = t_users.ObjectID  ORDER BY    ObjectDescription";
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p align="left"><a href="setup_user_defaultchannel_priv.php" target="_self"><strong>Click Here To Fix These </strong></a></p>
<p>&nbsp;</p>
