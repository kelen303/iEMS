...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "viewpreferences.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_crsolutions, $crsolutions);
$query_unnattachedpoints = "SELECT  t1.objectid, t1.channelid, t1.channeldescription FROM t_pointchannels t1 Left Join t_pointchannelpreferences t2  on t1.objectid = t2.pointobjectid where t2.userpreferenceid is null";
